...
def generate_master_data(session: Session) -> None:
    ...
    provinces = [
        ...
        Coast(abbr="ank", name="Ankara", jname="アンカラ", suppliable=True, region=power_t),
        ...
        Coast(abbr="ber", name="Berlin", jname="ベルリン", suppliable=True, region=power_g),
        ...
        Coast(abbr="bre", name="Brest", jname="ブレスト", suppliable=True, region=power_f),
        Inland(abbr="bud", name="Budapest", jname="ブダペスト", suppliable=True, region=power_a),
        ...
        Coast(abbr="con", name="Constantinople", jname="コンスタンティノープル", suppliable=True, region=power_t),
        Coast(abbr="den", name="Denmark", jname="デンマーク", suppliable=True),
        Water(abbr="eas", name="Eastern Mediterranean", jname="東地中海"),
        Coast(abbr="edi", name="Edinburgh", jname="エディンバラ", suppliable=True, region=power_e),
        ...
        Coast(abbr="kie", name="Kiel", jname="キール", suppliable=True, region=power_g),
        Coast(abbr="lon", name="London", jname="ロンドン", suppliable=True, region=power_e),
        Coast(abbr="lvn", name="Livonia", jname="リヴォニア", region=power_r),
        Coast(abbr="lvp", name="Liverpool", jname="リヴァプール", suppliable=True, region=power_e),
        Water(abbr="lyo", name="Gulf of Lyon", jname="リオン湾"),
        Water(abbr="mao", name="Mid-Atlantic Ocean", jname="中大西洋"),
        Coast(abbr="mar", name="Marseilles", jname="マルセイユ", suppliable=True, region=power_f),
        Inland(abbr="mos", name="Moscow", jname="モスクワ", suppliable=True, region=power_r),
        Inland(abbr="mun", name="Munich", jname="ミュンヘン", suppliable=True, region=power_g),
        Coast(abbr="naf", name="North Africa", jname="北アフリカ"),
        Water(abbr="nao", name="North Atlantic Ocean", jname="北大西洋"),
        Coast(abbr="nap", name="Naples", jname="ナポリ", suppliable=True, region=power_i),
        ...
        Inland(abbr="par", name="Paris", jname="パリ", suppliable=True, region=power_f),
        ...
        Coast(abbr="rom", name="Rome", jname="ローマ", suppliable=True, region=power_i),
        ...
        Coast(abbr="sev", name="Sevastopol", jname="セヴァストポリ", suppliable=True, region=power_r),
        Inland(abbr="sil", name="Silesia", jname="シレジア", region=power_g),
        Water(abbr="ska", name="Skagerrak", jname="スカゲラク海峡"),
        Coast(abbr="smy", name="Smyrna", jname="スミルナ", suppliable=True, region=power_t),
        ...
        Coast(abbr="stp", name="St. Petersburg", jname="サンクトペテルブルク", suppliable=True, region=power_r),
        ...
        Coast(abbr="tri", name="Trieste", jname="トリエステ", suppliable=True, region=power_a),
        ...
        Coast(abbr="ven", name="Venice", jname="ヴェネツィア", suppliable=True, region=power_i),
        Inland(abbr="vie", name="Vienna", jname="ウィーン", suppliable=True, region=power_a),
        Coast(abbr="wal", name="Wales", jname="ウェールズ", region=power_e),
        Inland(abbr="war", name="Warsaw", jname="ワルシャワ", suppliable=True, region=power_r),
